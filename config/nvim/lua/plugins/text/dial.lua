...
M.keys = function()
  ...
  return {
    ...
    { mode = "v", "t", manipulate("increment", "visual"), desc = "Increment Number/Date..." },
    { mode = "n", "T", manipulate("decrement", "normal"), desc = "Decrement Number/Date..." },
    { mode = "v", "T", manipulate("decrement", "visual"), desc = "Decrement Number/Date..." },
    ...
    { mode = "v", "gt", manipulate("increment", "gvisual"), desc = "Increment Number/Date... with Offset" },
    { mode = "n", "gT", manipulate("decrement", "gnormal"), desc = "Decrement Number/Date... with Offset" },
    { mode = "v", "gT", manipulate("decrement", "gvisual"), desc = "Decrement Number/Date... with Offset" },
  }
end
