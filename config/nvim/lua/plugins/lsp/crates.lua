  ...
  init = function()
    ...
    vim.api.nvim_create_autocmd("BufRead", {
      ...
      callback = function(options)
        ...
        map("n", "<leader>cce", function() require("crates").expand_plain_crate_to_inline_table() end, "Expand Plain Crate to Inline Table", opts)
        map("n", "<leader>ccE", function() require("crates").extract_crate_into_table() end, "Extract Crate Declaration Into a TOML Section", opts)
        -- Upgrade/Update
        ...
        map("x", "<leader>ccu", function() require("crates").update_crates() end, "Update Selected Crates (minor version)", opts)
        map("n", "<leader>ccU", function() require("crates").update_all_crates() end, "Update All Crates (minor version)", opts)
        -- Open
