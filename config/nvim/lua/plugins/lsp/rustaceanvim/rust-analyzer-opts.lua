...
M.on_attach = function(client, bufnr)
  ...
  map("n", "<leader>c<F1>", "<CMD>RustLsp externalDocs<CR>", "[RS] Open Doc under Cursor")
  ...
  map("n", "<leader>de", "<CMD>RustLsp explainError<CR>", "[RS] Explain Error")
  map("n", "<leader>dr", "<CMD>RustLsp renderDiagnostic<CR>", "[RS] Render Diagnostics")
