...
M.keys = function()
  ...
  return {
    ...
    -- { "gO", "<CMD>lua require('telescope').extensions.aerial.aerial()<CR>", desc = "Symbols (Telescope)" },
    -- BUG: Float mode always does not show anything
    -- { "gO", "<CMD>AerialToggle float<CR>", desc = "Symbols float (Aerial)" },
