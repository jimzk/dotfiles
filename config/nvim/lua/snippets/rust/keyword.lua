...
return {
  s({ trig = "o", desc = "Option<…>" }, fmt("Option<{}>", { i(1, "T") })),
  s({ trig = "so", desc = "Some(…)" }, fmt("Some({})", { i(1, "()") })),
  ...
  s({ trig = "s", desc = "String" }, fmt("String", {})),
  ...
  s({ trig = "wh", desc = "while" }, {
    t("while "),
    i(1, "true"),
    t(" "),
    util.rust.body(0, true),
  }),
  s({ trig = "whl", desc = "while let" }, {
    t("while let "),
    for_choice_c(1),
    t(" "),
    util.rust.body(0, true),
