...
map("n", "<C-Enter>", [[<cmd>silent! exec "normal! \<C-]>zz"<cr>]])
-- map("n", "<C-o>", [[<cmd>silent! exec "normal! \<C-o>zz"<cr>]])
-- map("n", "<C-i>", [[<cmd>silent! exec "normal! \<C-i>"<cr>zz]])
...
map({ "n", "x" }, "sd", '"_d', "Blackhole d")
map({ "n" }, "sdd", '"_dd')
map({ "n", "x" }, "sD", '"_D', "Blackhole D")

map({ "n", "x" }, "sc", '"_c', "Blackhole c")
map({ "n" }, "scc", '"_cc')
map({ "n", "x" }, "sC", '"_C', "Blackhole C")
